...
readonly ROUTER_CURRENT=/opt/codex-account-router/releases/codex-account-router-0.2.35-linux-x64
readonly WEB_CURRENT=/opt/0xcaff-codex-web-router/releases/c3e92f0f-20260803-m69-router-r119-manager-framing
