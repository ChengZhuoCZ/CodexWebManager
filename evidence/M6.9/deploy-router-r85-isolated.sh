...
readonly RELEASE_NAME=c3e92f0f-20260801-m69-router-r85
readonly PRODUCTION_ARCHIVE=/tmp/codex-m69-r85-web-overlay.tar.gz
readonly PRODUCTION_ARCHIVE_SHA256=2fd59e23736b17d37f6109d97e6abdda65e20b16762035e5324723ce7b91d830
...
if [[ -n "$fixture_root" ]]; then
  ...
  readonly ARCHIVE=${R85_ARCHIVE:?}
  readonly ARCHIVE_SHA256=${R85_ARCHIVE_SHA256:?}
  readonly SYSTEMCTL=${R85_SYSTEMCTL:?}
  readonly REPO_ROOT=$PWD
  readonly EXPECTED_WEB_BASE_SHA256=${R85_OLD_WEB_UNIT_SHA256:?}
  readonly EXPECTED_APP_BASE_SHA256=${R85_OLD_APP_UNIT_SHA256:?}
  readonly EXPECTED_ACCOUNT_BASE_SHA256=${R85_ACCOUNT_UNIT_SHA256:?}
  readonly EXPECTED_WEB_ISOLATION_SHA256=${R85_WEB_ISOLATION_SHA256:?}
  readonly EXPECTED_APP_ISOLATION_SHA256=${R85_APP_ISOLATION_SHA256:?}
  readonly EXPECTED_ACCOUNT_ISOLATION_SHA256=${R85_ACCOUNT_ISOLATION_SHA256:?}
  readonly EXPECTED_PREVIOUS_ELECTRON_SHA256=${R85_PREVIOUS_ELECTRON_SHA256:?}
