...
readonly RELEASE_NAME=c3e92f0f-20260802-m69-router-r91-standalone-panel
...
readonly INSTALLER_SHA256=737b98331c934958d3cfb5bbd2d15939e50c9bd455830b92dfb3229d3e1c1fce
readonly PANEL_MODULE_SHA256=c4f3be1f8122da4f8a2f9da61054c325126af412d5cf09d4ca037e4163e058f9
...
readonly STANDALONE_INDEX_SHA256=f9116342677d6d51fc033fe87779f63b07ea5aca4f30a9e545b262e8a42d28da
...
verify_qualified_assets() {
  local root=$1
  [[ "$(sha256 "${root}/scratch/asar/webview/index.html")" == "$QUALIFIED_INDEX_SHA256" ]]
...
rollback() {
  ...
  if [[ "$success" -ne 1 ]]; then
    if [[ "$current_switched" -eq 1 ]]; then
      local rollback_link="${WEB_PREFIX}/.current-r91-rollback.$$"
...
next_link="${WEB_PREFIX}/.current-r91.$$"
