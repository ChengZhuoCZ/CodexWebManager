...
- 8216 reproducible esbuild minification, Brotli delivery, startup background,
  signed-in composer, single-account model request, and post-fix log boundary
  are verified in release r10;
