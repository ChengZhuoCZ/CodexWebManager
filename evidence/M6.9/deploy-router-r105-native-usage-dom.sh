...
readonly RELEASE_NAME=c3e92f0f-20260802-m69-router-r105-native-usage-dom
readonly WEB_ROOT=/opt/0xcaff-codex-web-router
readonly WEB_CURRENT="${WEB_ROOT}/current"
readonly EXPECTED_CURRENT="${WEB_ROOT}/releases/c3e92f0f-20260802-m69-router-r104-native-usage-sync"
...
readonly INSTALLER="${R105_INSTALLER:-/tmp/replace-r105-router-native-usage-dom.mjs}"
readonly GENERIC_INSTALLER="${R105_GENERIC_INSTALLER:-/tmp/replace-standalone-router-panel.mjs}"
readonly PANEL_SOURCE="${R105_PANEL_SOURCE:-/tmp/router-account-panel-standalone.js}"
readonly QUOTA_DROPIN=/etc/systemd/system/codex-web-router.service.d/quota-refresh.conf
readonly INSTALLER_SHA256=3712d19658ca12f61630687616937de2a78dfe7c90a0684a03128ff8a4568cec
readonly GENERIC_INSTALLER_SHA256=e41ef09d15848c2f32e4142558b459ccb1501036ebddd454c91e2b0f4f78ef27
readonly PANEL_SOURCE_SHA256=673d9a21fce3b64cea49605958d0d92fd7c4d1974f5f1e3415126a2b6d1f6214
...
readonly SOURCE_PANEL_ASSET=router-account-panel-f9d5a01a.js
readonly SUCCESSOR_PANEL_ASSET=router-account-panel-673d9a21.js
readonly SOURCE_INDEX_SHA256=eeb15b26ec72cc2df4428fac0e30c9993b7f79d4bbe693539093dc7923ca4720
readonly SOURCE_INDEX_GZIP_SHA256=ef607d14769857fac805abd342c507860d87de2a2148f7bba626da14be2f1cbd
readonly SOURCE_INDEX_BROTLI_SHA256=998954f85eefeda0640c9e6f78c29dd5c4597c0a1925720bfde83a71b380ce24
readonly SOURCE_PANEL_SHA256=f9d5a01a6b5c535c3d2f3bcb047464eed7f6d3a9da81977aa2356276de0be3fc
readonly SOURCE_PANEL_GZIP_SHA256=1e25564cd7fd2d6042de02a18df32dc0cadef538aa0fbcda6b30e9bad227ade2
readonly SOURCE_PANEL_BROTLI_SHA256=45bdb629df9ebd18621b8b68f21ba3bc6c48727de17f65dce2183bdb9b9728e7
readonly SUCCESSOR_INDEX_SHA256=3adbde28ae4feb647955b5b455022bee7215858a51914b7cf8b3397b0f2f6585
readonly SUCCESSOR_INDEX_GZIP_SHA256=80eebf5a811d5b263099072efdf522140c0822eca1064402e02321ecde9f0905
readonly SUCCESSOR_INDEX_BROTLI_SHA256=725ddc15bdaa3d54e25c2edd65d8ec365b25d7e6c7dd734d9f583702f1a2f8f9
readonly SUCCESSOR_PANEL_GZIP_SHA256=ba5d0ab788fa213539f5ab0ddc3bddc19b2991a64b09fc7aaee5441e01d2b7f8
readonly SUCCESSOR_PANEL_BROTLI_SHA256=c0918d660e629523b3331058af683f12917363830db4596fee27257dd53c4d9e
...
rollback() {
  ...
  if [[ "$success" -ne 1 ]]; then
    if [[ "$current_switched" -eq 1 && -n "$current_before" ]]; then
      local rollback_link="${WEB_ROOT}/.current-r105-rollback.$$"
...
umask 077
workdir=$(mktemp -d /tmp/m69-r105-deploy.XXXXXX)
for unit in "$WEB_SERVICE" "$APP_SERVICE" "$ROUTER_SERVICE" "$STANDALONE_WEB_SERVICE" "$STANDALONE_APP_SERVICE"; do
...
next_link="${WEB_ROOT}/.current-r105.$$"
...
printf 'native_usage_values_are_not_help_links=true\n'
