...
readonly RELEASE_NAME=c3e92f0f-20260803-m69-router-r114-native-profile-menu
...
readonly INPUT_ROOT="${R114_INPUT_ROOT:-/tmp/codex-r114-deploy-inputs}"
readonly INSTALLER="${INPUT_ROOT}/replace-r114-native-profile-menu.mjs"
...
readonly INSTALLER_SHA256=29939c310597720b3fbfe3f18f4dbb033c38929a184b8c9947997aa91f1c2944
readonly GENERIC_INSTALLER_SHA256=e41ef09d15848c2f32e4142558b459ccb1501036ebddd454c91e2b0f4f78ef27
readonly PANEL_SOURCE_SHA256=0f9f3a68fd6e26b1070b98ae04df5d044c4b954d1e550b4dbad3c0f32eb19f17
...
readonly SUCCESSOR_PANEL_ASSET=router-account-panel-0f9f3a68.js
...
readonly SUCCESSOR_INDEX_SHA256=55330fd8db8ab3db3c46e316c44e863f99a0ceed27ca7b9d03e5945c4959636c
readonly SUCCESSOR_INDEX_GZIP_SHA256=0ed2fb1205e0193791de7f3215191b9c3a4f661fc637bf41a1eb3ecc5fb71fa5
readonly SUCCESSOR_INDEX_BROTLI_SHA256=75b644afe7f628725c01b4bd81495d60b49b5abf3a9519964b5e8e03808338ad
readonly SUCCESSOR_PANEL_GZIP_SHA256=3e42d6975845f3c9af588834b8708b4384954e18f1c8c03c70a63cc3fb16d1d0
readonly SUCCESSOR_PANEL_BROTLI_SHA256=075a6e0e2c72f4c26a940bc5b59ba78cf9cf4209780b943273a3dcf65a3a471d
...
rollback() {
  ...
  if [[ "$success" -ne 1 ]]; then
    if [[ "$current_switched" -eq 1 && -n "$current_before" ]]; then
      local rollback_link="${WEB_ROOT}/.current-r114-rollback.$$"
...
umask 077
workdir=$(mktemp -d /tmp/m69-r114-deploy.XXXXXX)
for unit in "$WEB_SERVICE" "$APP_SERVICE" "$ROUTER_SERVICE" "$MANAGER_SERVICE" "$MANAGER_SOCKET" \
  "$STANDALONE_WEB_SERVICE" "$STANDALONE_APP_SERVICE"; do
...
next_link="${WEB_ROOT}/.current-r114.$$"
...
printf 'native_profile_menu_integration=true\n'
printf 'react_footer_mutation=false\n'
printf 'body_mutation_observer=false\n'
printf 'bounded_profile_menu_render_attempts=5\n'
