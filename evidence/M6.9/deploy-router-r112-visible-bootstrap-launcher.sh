...
readonly RELEASE_NAME=c3e92f0f-20260803-m69-router-r112-visible-bootstrap-launcher
readonly WEB_ROOT=/opt/0xcaff-codex-web-router
readonly WEB_CURRENT="${WEB_ROOT}/current"
readonly EXPECTED_CURRENT="${WEB_ROOT}/releases/c3e92f0f-20260803-m69-router-r111-safari-account-launcher"
...
readonly INPUT_ROOT="${R112_INPUT_ROOT:-/tmp/codex-r112-deploy-inputs}"
readonly INSTALLER="${INPUT_ROOT}/replace-r112-visible-bootstrap-launcher.mjs"
...
readonly INSTALLER_SHA256=f7831f42e37bc41cd1b87f7a6903bfa174187907941ce2bc1c64914814eb9500
readonly GENERIC_INSTALLER_SHA256=e41ef09d15848c2f32e4142558b459ccb1501036ebddd454c91e2b0f4f78ef27
readonly PANEL_SOURCE_SHA256=8a5b36594e6fd0c1dce9601d02ddefaa2ba0dc52a14babc2e3d9bd90fee1487d

readonly INDEX=scratch/asar/webview/index.html
readonly ASSETS=scratch/asar/webview/assets
readonly SOURCE_PANEL_ASSET=router-account-panel-2043970f.js
readonly SUCCESSOR_PANEL_ASSET=router-account-panel-8a5b3659.js
readonly SOURCE_INDEX_SHA256=15bb17ff609a50a57143e4a3481a853dbf6a00950d4db4f95beb4de1e4b2622a
readonly SOURCE_INDEX_GZIP_SHA256=8e05801a07034c07761ea2d56121d5351d95142ab5baa48651cf7cf2fad16b55
readonly SOURCE_INDEX_BROTLI_SHA256=cde743144b2894d7b823903089b038fef861ba63a845b91bc814318e11cbd731
readonly SOURCE_PANEL_SHA256=2043970fdfe436b46f900e7041e8d8c4cbdce019db551b2b0f1517e09013b88a
readonly SOURCE_PANEL_GZIP_SHA256=1107ddb1608c8be578cd342ae2be091fbacc2aba66731d6a8291f7b525e7c4e3
readonly SOURCE_PANEL_BROTLI_SHA256=bb1ac8c7cc42f132887215b066dc06b0e07b58c504c273ff44a84b39ca60d8b8
readonly SUCCESSOR_INDEX_SHA256=2791f3ad2fa2d761a0484cdb6ae595965dd7d3dc4c222b6b01d76509e86656bf
readonly SUCCESSOR_INDEX_GZIP_SHA256=874f5421e97598a46b25c5fd124dd8a503167a5a1c20c07468bf0b8b04d1d685
readonly SUCCESSOR_INDEX_BROTLI_SHA256=4dd379af19ec81936a1878fc25919ed3bbae4982f289b1a55af71b7b7084b451
readonly SUCCESSOR_PANEL_GZIP_SHA256=0074a67bfbcf1fcd1df5c45f63aa5f6241a4a60d0eee68cc1ea4e48e4d8ba6e9
readonly SUCCESSOR_PANEL_BROTLI_SHA256=cdfaeb6df693cc0229866ac55dbdae0f301ee0b9fa73ffd70a63743413da996a
...
rollback() {
  ...
  if [[ "$success" -ne 1 ]]; then
    if [[ "$current_switched" -eq 1 && -n "$current_before" ]]; then
      local rollback_link="${WEB_ROOT}/.current-r112-rollback.$$"
...
umask 077
workdir=$(mktemp -d /tmp/m69-r112-deploy.XXXXXX)
for unit in "$WEB_SERVICE" "$APP_SERVICE" "$ROUTER_SERVICE" "$MANAGER_SERVICE" "$MANAGER_SOCKET" \
  "$STANDALONE_WEB_SERVICE" "$STANDALONE_APP_SERVICE"; do
...
next_link="${WEB_ROOT}/.current-r112.$$"
