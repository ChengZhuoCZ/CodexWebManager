...
readonly RELEASE_NAME=c3e92f0f-20260803-m69-router-r111-safari-account-launcher
readonly WEB_ROOT=/opt/0xcaff-codex-web-router
readonly WEB_CURRENT="${WEB_ROOT}/current"
readonly EXPECTED_CURRENT="${WEB_ROOT}/releases/c3e92f0f-20260803-m69-router-r110-compact-auto-failover"
...
readonly INPUT_ROOT="${R111_INPUT_ROOT:-/tmp/codex-r111-deploy-inputs}"
readonly INSTALLER="${INPUT_ROOT}/replace-r111-safari-account-launcher.mjs"
...
readonly INSTALLER_SHA256=844f459ef47fb6191514950381ffb8f00eeb92c76e0db8bdf0be1601487bbc10
readonly GENERIC_INSTALLER_SHA256=e41ef09d15848c2f32e4142558b459ccb1501036ebddd454c91e2b0f4f78ef27
readonly PANEL_SOURCE_SHA256=2043970fdfe436b46f900e7041e8d8c4cbdce019db551b2b0f1517e09013b88a

readonly INDEX=scratch/asar/webview/index.html
readonly ASSETS=scratch/asar/webview/assets
readonly SOURCE_PANEL_ASSET=router-account-panel-23e50032.js
readonly SUCCESSOR_PANEL_ASSET=router-account-panel-2043970f.js
readonly SOURCE_INDEX_SHA256=5c74320da619209813e0883a90ab7744864ad2aff886dde44ac7ac5ccfbf9e7f
readonly SOURCE_INDEX_GZIP_SHA256=2dd1d5045902822391875afcf218478e6ff447ae8487051703e33492637bdbbf
readonly SOURCE_INDEX_BROTLI_SHA256=34c0a7c35ad382fbddd56a0c9f16f989f3cc1a3924fb052a8267a7eb5067df54
readonly SOURCE_PANEL_SHA256=23e5003262db751be029f0a1b32c8945601d1536d8beda8d7457a83367c1d4fe
readonly SOURCE_PANEL_GZIP_SHA256=c37b0580cff540ea875443f7f0ac6a71b262c76557f8046538945d129a1365e8
readonly SOURCE_PANEL_BROTLI_SHA256=b62b36bc76c462f285277b349de10433718de45cc355800d8453d9365a2666cf
readonly SUCCESSOR_INDEX_SHA256=15bb17ff609a50a57143e4a3481a853dbf6a00950d4db4f95beb4de1e4b2622a
readonly SUCCESSOR_INDEX_GZIP_SHA256=8e05801a07034c07761ea2d56121d5351d95142ab5baa48651cf7cf2fad16b55
readonly SUCCESSOR_INDEX_BROTLI_SHA256=cde743144b2894d7b823903089b038fef861ba63a845b91bc814318e11cbd731
readonly SUCCESSOR_PANEL_GZIP_SHA256=1107ddb1608c8be578cd342ae2be091fbacc2aba66731d6a8291f7b525e7c4e3
readonly SUCCESSOR_PANEL_BROTLI_SHA256=bb1ac8c7cc42f132887215b066dc06b0e07b58c504c273ff44a84b39ca60d8b8
...
rollback() {
  ...
  if [[ "$success" -ne 1 ]]; then
    if [[ "$current_switched" -eq 1 && -n "$current_before" ]]; then
      local rollback_link="${WEB_ROOT}/.current-r111-rollback.$$"
...
umask 077
workdir=$(mktemp -d /tmp/m69-r111-deploy.XXXXXX)
for unit in "$WEB_SERVICE" "$APP_SERVICE" "$ROUTER_SERVICE" "$MANAGER_SERVICE" "$MANAGER_SOCKET" \
  "$STANDALONE_WEB_SERVICE" "$STANDALONE_APP_SERVICE"; do
...
next_link="${WEB_ROOT}/.current-r111.$$"
...
printf 'safari_always_visible_account_launcher=true\n'
printf 'native_profile_menu_adapter_retained=true\n'
