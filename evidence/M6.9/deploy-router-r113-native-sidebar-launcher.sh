...
readonly RELEASE_NAME=c3e92f0f-20260803-m69-router-r113-native-sidebar-launcher
...
readonly INPUT_ROOT="${R113_INPUT_ROOT:-/tmp/codex-r113-deploy-inputs}"
readonly INSTALLER="${INPUT_ROOT}/replace-r113-native-sidebar-launcher.mjs"
...
readonly INSTALLER_SHA256=4cbca67e39877aeeff10378d72c5c964e70153b6f70917bf0c5687683caf8667
readonly GENERIC_INSTALLER_SHA256=e41ef09d15848c2f32e4142558b459ccb1501036ebddd454c91e2b0f4f78ef27
readonly PANEL_SOURCE_SHA256=8102f63226b9b0bdb36a6fd0ec34d9313122aa4b10058ec6c970b5dc9c45c1b7
...
readonly SUCCESSOR_PANEL_ASSET=router-account-panel-8102f632.js
...
readonly SUCCESSOR_INDEX_SHA256=a3581c6dbc9cc16d72cee07dd3760154b7acef7769ac1431806b24b8931b6a10
readonly SUCCESSOR_INDEX_GZIP_SHA256=0eb3dbc683167adc7e36c566c81215bbbb8885d6fd4e1f3191a2a52a453d24d4
readonly SUCCESSOR_INDEX_BROTLI_SHA256=490d43e4e0fc5befe5dca9756a0eda4fa1271e5be51ef43ad8ff57ed02ef0268
readonly SUCCESSOR_PANEL_GZIP_SHA256=ebd5b8b4536625d7f8f8154d30109951fff1fcd6a20fdb25642e473d702ca3de
readonly SUCCESSOR_PANEL_BROTLI_SHA256=f94b1de88d1999d3442ca435245ae7edce50571b04625dd750cbd016f73d6ea4
...
rollback() {
  ...
  if [[ "$success" -ne 1 ]]; then
    if [[ "$current_switched" -eq 1 && -n "$current_before" ]]; then
      local rollback_link="${WEB_ROOT}/.current-r113-rollback.$$"
...
umask 077
workdir=$(mktemp -d /tmp/m69-r113-deploy.XXXXXX)
for unit in "$WEB_SERVICE" "$APP_SERVICE" "$ROUTER_SERVICE" "$MANAGER_SERVICE" "$MANAGER_SOCKET" \
  "$STANDALONE_WEB_SERVICE" "$STANDALONE_APP_SERVICE"; do
...
next_link="${WEB_ROOT}/.current-r113.$$"
...
printf 'native_left_bottom_launcher=true\n'
