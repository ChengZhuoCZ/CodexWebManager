...
//#endregion
//#region node_modules/.pnpm/@tanstack+query-core@5.101.4/node_modules/@tanstack/query-core/build/modern/index.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query@5.101.4_react@19.2.8/node_modules/@tanstack/react-query/build/modern/types.js
...
var import_react$6, import_jsx_runtime$6, QueryClientContext, useQueryClient, QueryClientProvider;
var init_QueryClientProvider = __esmMin((() => {
	...
	QueryClientContext = import_react$6.createContext(void 0);
	useQueryClient = (queryClient) => {
		const client = import_react$6.useContext(QueryClientContext);
	...
	QueryClientProvider = ({ client, children }) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime$6.jsx)(QueryClientContext.Provider, {
			value: client,
			children
		});
	};
})), import_react$5, IsRestoringContext, useIsRestoring;
var init_IsRestoringProvider = __esmMin((() => {
	import_react$5 = /* @__PURE__ */ __toESM(require_react(), 1);
	IsRestoringContext = import_react$5.createContext(false);
	useIsRestoring = () => import_react$5.useContext(IsRestoringContext);
...
var import_react$4, QueryErrorResetBoundaryContext, useQueryErrorResetBoundary;
var init_QueryErrorResetBoundary = __esmMin((() => {
	import_react$4 = /* @__PURE__ */ __toESM(require_react(), 1);
	require_jsx_runtime();
	QueryErrorResetBoundaryContext = import_react$4.createContext(createValue());
	useQueryErrorResetBoundary = () => import_react$4.useContext(QueryErrorResetBoundaryContext);
}));
//#endregion
...
var import_react$3, ensurePreventErrorBoundaryRetry, useClearResetErrorBoundary, getHasError;
...
function useBaseQuery(options, Observer, queryClient) {
	...
	const [observer] = import_react$2.useState(() => new Observer(client, defaultedOptions));
	const result = observer.getOptimisticResult(defaultedOptions);
	const shouldSubscribe = !isRestoring && subscribed;
	import_react$2.useSyncExternalStore(import_react$2.useCallback((onStoreChange) => {
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-query@5.101.4_react@19.2.8/node_modules/@tanstack/react-query/build/modern/index.js
...
function WorkspaceRootDialog({ listDirectory, onClose }) {
	const [directoryPath, setDirectoryPath] = (0, import_react$1.useState)(null);
	const [userSelectedPath, setUserSelectedPath] = (0, import_react$1.useState)(null);
	...
	const entries = (0, import_react$1.useMemo)(() => directoryQuery.data?.entries.filter((entry) => entry.type === "directory") ?? [], [directoryQuery.data?.entries]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)(import_jsx_runtime$1.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
		...
		style: { pointerEvents: "auto" },
		tabIndex: -1,
		children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("form", {
			className: [
				"flex",
				"flex-col",
				"gap-0"
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("button", {
											...
											type: "button",
											children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(UpIcon, {})
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
											...
											children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
												className: [
													"px-3",
													"py-2",
													"text-sm",
												...
												children: "Loading..."
											}) : queryError ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
												className: [
													"px-3",
													"py-2",
													"text-sm",
												...
												children: queryError
											}) : entries.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("div", {
												className: [
													"px-3",
													"py-2",
													"text-sm",
												...
												return /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("button", {
													...
													title: entry.path,
													type: "button",
													children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(FolderIcon, {}), /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)("span", {
...
async function openSelectWorkspaceRootDialog({ listDirectory }) {
	...
	const reactRoot = (0, import_client$1.createRoot)(ensureHost());
	reactRoot.render(/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(WorkspaceRootDialog, {
			listDirectory,
			onClose: resolveFn
		})
	}));
...
var import_react$1, import_client$1, import_jsx_runtime$1, TITLE_ID, DESCRIPTION_ID;
...
//#endregion
//#region src/browser/account-settings-window.tsx
function visibleRectangle(element) {
	const rectangle = element.getBoundingClientRect();
	if (rectangle.width <= 0 || rectangle.height <= 0 || rectangle.bottom < 0 || rectangle.right < 0 || rectangle.top > window.innerHeight || rectangle.left > window.innerWidth) return null;
	return rectangle;
}
function profileButtonCandidates() {
	...
	for (const candidate of document.querySelectorAll(PROFILE_BUTTON_FALLBACK_SELECTOR)) {
		...
		if (rectangle !== null && rectangle.left < Math.max(420, window.innerWidth * .4)) candidates.push(candidate);
	}
	return candidates;
}
function expandedProfileButton() {
	return profileButtonCandidates().find((candidate) => candidate.getAttribute("aria-expanded") === "true") ?? null;
}
...
function profileMenuDistance(menu, button) {
	...
	return Math.max(0, buttonRectangle.left - menuRectangle.right, menuRectangle.left - buttonRectangle.right) * 4 + Math.abs(buttonRectangle.top - menuRectangle.bottom);
}
function findProfileMenu() {
	...
	return [...document.querySelectorAll(PROFILE_MENU_SELECTOR)].filter((candidate) => candidate instanceof HTMLElement && visibleRectangle(candidate) !== null && candidate.querySelector(PROFILE_MENU_ITEM_SELECTOR) !== null).sort((left, right) => profileMenuDistance(left, button) - profileMenuDistance(right, button))[0] ?? null;
}
function useNativeProfileMenu() {
	...
	(0, import_react.useEffect)(() => {
		...
		const schedule = () => {
			cancel();
			for (const delay of MENU_INSPECTION_DELAYS_MS) timers.push(window.setTimeout(() => setMenu(findProfileMenu()), delay));
		};
		const activation = (event) => {
			if (event.type === "keydown" && (!(event instanceof KeyboardEvent) || !(/* @__PURE__ */ new Set(["Enter", " "])).has(event.key))) return;
			const target = event.target;
			if (!(target instanceof Element)) return;
			const button = target.closest(PROFILE_BUTTON_FALLBACK_SELECTOR);
			if (button instanceof HTMLElement && profileButtonCandidates().includes(button) || findProfileMenu() !== null) schedule();
		};
...
function useAccountController() {
	const [controller, setController] = (0, import_react.useState)(() => window.__CODEX_ROUTER_ACCOUNT_SETTINGS__ ?? null);
	(0, import_react.useEffect)(() => {
		const refresh = () => {
	...
	return {
		controller,
		snapshot: (0, import_react.useSyncExternalStore)(controller?.subscribe ?? (() => () => {}), controller?.getSnapshot ?? (() => EMPTY_SNAPSHOT), () => EMPTY_SNAPSHOT)
	};
}
async function copyDeviceCode(value) {
	if (!/^[A-Z0-9]{4}(?:-[A-Z0-9]{4})+$/u.test(value)) throw new Error("device authorization code is invalid");
	const writeText = navigator.clipboard?.writeText;
	if (typeof writeText === "function") try {
...
function ManagementPanel({ snapshot, controller }) {
	const [alias, setAlias] = (0, import_react.useState)("");
	const [copyLabel, setCopyLabel] = (0, import_react.useState)("Copy code");
	...
	if (management.mode === "add_alias") {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
			className: "mt-3 rounded-xl bg-token-bg-tertiary p-3",
			onSubmit: submit,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
				className: "flex flex-col gap-2 text-sm font-medium",
				children: ["Account name", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "rounded-lg px-3 py-2 text-sm hover:bg-token-bg-secondary",
					onClick: controller.actions.cancelManagement,
					type: "button",
					children: "Cancel"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "rounded-lg bg-token-text-primary px-3 py-2 text-sm text-token-bg-primary",
					type: "submit",
					children: "Authorize"
				})]
			})]
	...
	if ((/* @__PURE__ */ new Set([
		...
		"waiting",
		"installing"
	])).has(management.mode)) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mt-3 rounded-xl bg-token-bg-tertiary p-3 text-sm",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: management.mode === "installing" ? "Authorization received. Installing account…" : "Authorize this account in your browser:" }),
			management.verificationUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
				className: "mt-2 block underline",
				href: management.verificationUrl,
				rel: "noopener noreferrer",
				target: "_blank",
				children: management.verificationUrl
			}) : null,
			management.userCode ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-3 flex items-center gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
					className: "min-w-0 flex-1 select-all text-base font-semibold tracking-wider",
					children: management.userCode
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				className: "mt-3 rounded-lg px-3 py-2 hover:bg-token-bg-secondary",
				onClick: controller.actions.cancelManagement,
				type: "button",
				children: "Cancel"
			})
	...
	if (management.mode === "remove_confirm" && management.alias) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mt-3 rounded-xl bg-token-bg-tertiary p-3 text-sm",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
			"Remove ",
			management.alias,
			"? Its stored credential will be erased."
		] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mt-3 flex justify-end gap-2",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				className: "rounded-lg px-3 py-2 hover:bg-token-bg-secondary",
				...
				onClick: () => controller.actions.confirmRemove(management.alias ?? ""),
				type: "button",
				children: ["Delete ", management.alias]
			})]
		})]
	});
	if (management.mode === "remove_working") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mt-3 rounded-xl bg-token-bg-tertiary p-3 text-sm",
		children: [
			"Deleting ",
			management.alias,
...
function AccountRow({ account, snapshot, controller }) {
	const removalDisabled = snapshot.model === null || snapshot.model.accounts.length <= 1 || account.isCurrent || snapshot.model.activeStreams > 0 || snapshot.management.mode !== "idle";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex items-center gap-2 rounded-xl px-3 py-2 hover:bg-token-bg-secondary",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "truncate",
							children: account.alias
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs text-token-text-secondary",
							children: account.stateLabel
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "mt-1 flex flex-wrap gap-x-3 gap-y-1 text-xs text-token-text-secondary",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Weekly ", account.weeklyLabel.replace(" remaining", "")] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Cooldown ", account.cooldownLabel] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "mt-1 block text-xs text-token-text-tertiary",
						children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: account.isCurrent ? "text-xs font-semibold text-green-600" : "text-xs font-semibold",
				children: account.isCurrent ? "Current" : snapshot.busyAlias === account.alias ? "Switching…" : "Switch"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
function AccountSettingsDialog({ controller, snapshot, onClose }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		"aria-hidden": "true",
		className: "codex-dialog-overlay fixed inset-0 z-50 electron:bg-[#00000022] extension:bg-token-editor-background/80",
		"data-state": "open",
		onClick: onClose,
		style: { pointerEvents: "auto" }
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: "flex items-center justify-between border-b border-token-border px-5 py-4",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "heading-dialog font-semibold",
				children: "Account settings"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 text-xs text-token-text-secondary",
				children: "Automatic failover is limited to requests before semantic output."
			})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				"aria-label": "Close account settings",
				className: "h-8 w-8 rounded-lg text-xl hover:bg-token-bg-secondary",
				onClick: onClose,
				type: "button",
				children: "×"
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
			className: "max-h-[calc(92vh-82px)] overflow-y-auto px-4 py-4",
			children: [
				snapshot.transientMessage ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mb-3 rounded-xl bg-red-500/10 px-3 py-2 text-sm text-red-600",
					children: snapshot.transientMessage
				}) : null,
				snapshot.model?.banner ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mb-3 rounded-xl bg-amber-500/10 px-3 py-2 text-sm text-amber-700",
					children: snapshot.model.banner
				}) : null,
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mb-2 flex items-center justify-between px-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm font-semibold",
						children: "Account route"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs text-token-text-secondary",
						children: "Switching starts a new backend session."
					})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-full bg-green-500/10 px-2 py-1 text-xs font-semibold text-green-600",
								children: "Auto"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								className: "rounded-lg px-3 py-2 text-sm hover:bg-token-bg-secondary disabled:opacity-40",
								disabled: snapshot.model?.activeStreams !== 0 || snapshot.management.mode !== "idle",
								onClick: () => controller?.actions.beginAdd(),
								type: "button",
								children: "Add"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								"aria-label": "Refresh Primary weekly quota",
								className: "rounded-lg px-3 py-2 text-sm hover:bg-token-bg-secondary disabled:opacity-40",
								disabled: snapshot.quotaBusy || controller === null,
								onClick: () => controller?.actions.refreshQuota(),
								type: "button",
								children: snapshot.quotaBusy ? "Refreshing…" : "Refresh"
							})
						]
					})]
				}),
				controller ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ManagementPanel, {
					controller,
					snapshot
				}) : null,
				snapshot.model ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					"aria-label": `Account route (${snapshot.model.accounts.length})`,
					className: "mt-3 flex flex-col",
					role: "radiogroup",
					children: snapshot.model.accounts.map((account) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccountRow, {
						account,
						controller,
						snapshot
					}, account.alias))
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-3 rounded-xl bg-token-bg-tertiary p-4 text-sm text-token-text-secondary",
					children: [snapshot.status === "unavailable" ? "Router status is temporarily unavailable." : "Account settings are loading…", snapshot.status === "unavailable" && controller ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						className: "ml-2 underline",
						onClick: controller.actions.retryStatus,
						type: "button",
						children: "Retry"
					}) : null]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-4 px-2 text-xs text-token-text-tertiary",
					title: "Cross-account continuity is not verified.",
					children: "No request is replayed after semantic output. Existing sessions and in-flight work are not migrated."
				})
			]
		})]
	})] });
}
function nativeMenuClassName(menu) {
	const item = menu.querySelector(PROFILE_MENU_ITEM_SELECTOR);
	return item instanceof HTMLElement && typeof item.className === "string" ? item.className : "flex w-full cursor-default items-center gap-2 rounded-md px-2 py-2 text-sm outline-none hover:bg-token-bg-secondary";
}
function RouteIcon() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
			d: "M4 6.5h10.5m0 0-2.75-2.75M14.5 6.5l-2.75 2.75M16 13.5H5.5m0 0 2.75 2.75M5.5 13.5l2.75-2.75",
			stroke: "currentColor",
			strokeLinecap: "round",
...
function currentRouteAlias(snapshot) {
...
function AccountSettingsApp() {
	...
	const menuClassName = (0, import_react.useMemo)(() => menu ? nativeMenuClassName(menu) : "", [menu]);
	const routeAlias = currentRouteAlias(snapshot);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [menu ? (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "flex h-5 w-5 shrink-0 items-center justify-center text-token-text-secondary",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RouteIcon, {})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "min-w-0 flex-1 truncate text-token-text-primary",
				children: "Account route"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "max-w-24 shrink-0 truncate text-token-text-secondary",
				children: routeAlias
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "flex h-[18px] w-[18px] shrink-0 items-center justify-center text-token-text-tertiary",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRightIcon, {})
			})
		]
	}), menu) : null, open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccountSettingsDialog, {
		controller,
		onClose: () => setOpen(false),
		snapshot
	}) : null] });
}
function installAccountSettingsWindow() {
	...
	const install = () => {
		...
		installedRoot = (0, import_client.createRoot)(host);
		installedRoot.render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccountSettingsApp, {}));
	};
...
var import_react, import_react_dom, import_client, import_jsx_runtime, CONTROLLER_READY_EVENT, HOST_ID, PROFILE_BUTTON_SELECTOR, PROFILE_BUTTON_FALLBACK_SELECTOR, PROFILE_MENU_SELECTOR, PROFILE_MENU_ITEM_SELECTOR, MENU_INSPECTION_DELAYS_MS, EMPTY_SNAPSHOT, installedRoot;
var init_account_settings_window = __esmMin((() => {
	import_react = /* @__PURE__ */ __toESM(require_react());
	import_react_dom = require_react_dom();
	import_client = require_client();
	import_jsx_runtime = require_jsx_runtime();
	CONTROLLER_READY_EVENT = "codex-router-account-settings-ready";
	HOST_ID = "codex-router-account-settings-react-root";
	PROFILE_BUTTON_SELECTOR = "button[aria-label=\"Open profile menu\"]";
	PROFILE_BUTTON_FALLBACK_SELECTOR = "button[aria-haspopup=\"menu\"]";
	PROFILE_MENU_SELECTOR = "[role=\"menu\"]";
	PROFILE_MENU_ITEM_SELECTOR = "[role=\"menuitem\"]";
	MENU_INSPECTION_DELAYS_MS = [
		0,
		16,
		40,
		80,
...
function getBrowserWindowFocusState() {
	return document.visibilityState === "visible" && document.hasFocus();
}
function installBrowserWindowFocusListeners() {
	const handleFocusChange = () => {
		const isFocused = getBrowserWindowFocusState();
		if (isFocused === lastBrowserWindowFocusState) return;
...
async function showWebNotification(notification) {
...
function handleNotificationShowMessage(value) {
	if (typeof value !== "string") return;
	try {
		const message = JSON.parse(value);
		if (!Array.isArray(message) || message[0] !== "push" || !Array.isArray(message[1])) return;
		const pipeline = message[1];
		const method = pipeline[2];
		const args = pipeline[3];
		const notification = Array.isArray(args) ? args[0] : null;
		if (pipeline[0] === "pipeline" && Array.isArray(method) && method[0] === "show" && isRecord(notification) && typeof notification.kind === "string" && typeof notification.title === "string" && (notification.body === void 0 || typeof notification.body === "string") && (notification.id === void 0 || typeof notification.id === "string")) showWebNotification({
			body: notification.body,
			id: notification.id,
...
function isElectronWindowFocusRequestMessage(value) {
...
var RECONNECT_DELAY_MS, requestCounter, socket, reconnectTimeoutId, outboundQueue, pendingInvokes, pendingDirectoryEntries, rendererListeners, messagePorts, lastBrowserWindowFocusState, themeMediaQuery, mobileMediaQuery, initialSidebarState, electronShim, buildFlavor, initialRoute, ipcRenderer, contextBridge, webUtils;
var init_shim = __esmMin((() => {
	init_routes();
	init_files();
	init_workspace_root_dialog();
	init_account_settings_window();
	...
	messagePorts = /* @__PURE__ */ new Map();
	lastBrowserWindowFocusState = null;
	...
	electronShim.overrideAdapter = { getGateOverride(evaluation) {
		if (evaluation.name === "2911712394") return {
			...evaluation,
			value: true
		};
		if (evaluation.name === "1042620455") return {
			...evaluation,
			value: true
		};
		return null;
	...
	ipcRenderer = {
		...
		postMessage(channel, message, transfer) {
			if (transfer && transfer.length > 0) {
				enqueueMessage({
					...
					channel,
					message,
					portIds: transfer.map((transferable) => {
						if (!(transferable instanceof MessagePort)) throw new TypeError("Only MessagePort transfers are supported by the browser IPC bridge.");
						const portId = `message_port_${nextRequestId()}`;
						messagePorts.set(portId, transferable);
						transferable.addEventListener("message", (event) => {
							if (channel === "codex_desktop:connect-app-host") handleNotificationShowMessage(event.data);
							enqueueMessage({
		...
		sendSync(channel, ..._args) {
			...
			if (channel === "codex_desktop:get-initial-sidebar-bootstrap") return null;
...
var n = `codex_desktop:show-context-menu`;
var r = `codex_desktop:show-application-menu`;
var i = `codex_desktop:get-sentry-init-options`;
var a = `codex_desktop:get-build-flavor`;
var o = `codex_desktop:get-uses-owl-app-shell`;
var s = `codex_desktop:get-system-theme-variant`;
var c = `codex_desktop:get-fast-mode-rollout-metrics`;
var l = `codex_desktop:system-theme-variant-updated`;
var u = `codex_desktop:trigger-sentry-test`;
var d = `codex_desktop:connect-app-host`;
var f = `codex_desktop:start-file-drag`;
function p(e) {
...
var g = `electron`;
var _ = `codex_desktop:message-from-view`;
var v = `codex_desktop:message-for-view`;
var y = e.ipcRenderer.sendSync(i);
var b = e.ipcRenderer.sendSync(a);
var x = e.ipcRenderer.sendSync(o) === !0;
var S = e.ipcRenderer.sendSync(`codex_desktop:get-shared-object-snapshot`) ?? {};
var C = e.ipcRenderer.sendSync(s);
var w = C === `dark` ? `electron-dark` : `electron-light`;
